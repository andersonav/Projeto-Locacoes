...
--
-- Host: localhost    Database: sysreserva
-- ------------------------------------------------------
...
INSERT INTO `dias_semana` VALUES (1,'Domingo',0),(2,'Segunda',1),(3,'Terca',2),(4,'Quarta',3),(5,'Quinta',4),(6,'Sexta',5),(7,'Sabado',6);
...
INSERT INTO `equipamentos_evento` VALUES (1,'Microfones','40','alveesbezerra13@gmail.com'),(2,'DataShow','52','anderson.alvesprogrammer@gmail.com'),(6,'Caixa de Som','4','ok@gmail.com'),(7,'Computador','2','anderson@gmail.com'),(12,'dkfhdkshf','12','a@gmai.com');
/*!40000 ALTER TABLE `equipamentos_evento` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `evento_ativo`
--

DROP TABLE IF EXISTS `evento_ativo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `evento_ativo` (
  `eve_ati_id` int(11) NOT NULL AUTO_INCREMENT,
  `eve_ati_descricao` varchar(45) NOT NULL,
  PRIMARY KEY (`eve_ati_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `evento_ativo`
--

LOCK TABLES `evento_ativo` WRITE;
/*!40000 ALTER TABLE `evento_ativo` DISABLE KEYS */;
INSERT INTO `evento_ativo` VALUES (1,'Ativo'),(2,'Inativo');
/*!40000 ALTER TABLE `evento_ativo` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `evento_aula_detalhes` (
  ...
  KEY `fk_aula_detalhes__idx` (`eve_aula_det_fkeve_id`),
  KEY `fk_aula_detalhes_aula_id_idx` (`eve_aula_det_fkaula_id`),
  CONSTRAINT `fk_aula_detalhes_aula_id` FOREIGN KEY (`eve_aula_det_fkaula_id`) REFERENCES `evento_aula` (`eve_aula_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_aula_detalhes_eve_id` FOREIGN KEY (`eve_aula_det_fkeve_id`) REFERENCES `eventos` (`eve_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `evento_equipamento_utilizado` (
  ...
  KEY `fk_equipamento_eve_id_idx` (`eve_equi_uti_fkeve_id`),
  KEY `fk_equipamento_equi_id_idx` (`eve_equi_uti_fkequi_id`),
  CONSTRAINT `fk_equipamento_equi_id` FOREIGN KEY (`eve_equi_uti_fkequi_id`) REFERENCES `equipamentos_evento` (`equi_eve_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_equipamento_eve_id` FOREIGN KEY (`eve_equi_uti_fkeve_id`) REFERENCES `eventos` (`eve_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `evento_refeicao_utilizado` (
  ...
  KEY `fk_eventos_eve_id_idx` (`eve_ref_uti_fkeve_id`),
  KEY `fk_refeicao_ref_id_idx` (`eve_ref_uti_fkref_id`),
  CONSTRAINT `fk_refeicao_eve_id` FOREIGN KEY (`eve_ref_uti_fkeve_id`) REFERENCES `eventos` (`eve_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_refeicao_ref_id` FOREIGN KEY (`eve_ref_uti_fkref_id`) REFERENCES `refeicoes_evento` (`ref_eve_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `evento_servico_utilizado` (
  ...
  KEY `fk_servico_eve_id_idx` (`eve_ser_uti_fkeve_id`),
  KEY `fk_servico_ser_id_idx` (`eve_ser_uti_fkser_id`),
  CONSTRAINT `fk_servico_eve_id` FOREIGN KEY (`eve_ser_uti_fkeve_id`) REFERENCES `eventos` (`eve_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_servico_ser_id` FOREIGN KEY (`eve_ser_uti_fkser_id`) REFERENCES `servicos_evento` (`ser_eve_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `eventos` (
  ...
  `eve_logica` char(200) NOT NULL,
  `eve_random` bigint(15) NOT NULL,
  `eve_ativo` int(11) NOT NULL,
  `eve_fkfiltro_evento` int(11) NOT NULL,
  PRIMARY KEY (`eve_id`),
  KEY `fk_eventos_evento_tipo_repeticao1_idx` (`eve_tip_rep_id`),
  KEY `fk_eventos_ambiente_evento_idx` (`eve_amb_id`),
  KEY `fk_eventos_fkfiltro_evento_idx` (`eve_fkfiltro_evento`),
  KEY `fk_eventos_evento_aula_idx` (`eve_aula_id`),
  KEY `fk_eventos_usuario_idx` (`eve_usu_id`),
  KEY `fk_eventos_dia_codigo_idx` (`eve_fkdia_codigo`),
  KEY `fk_eventos_evento_ativo_idx` (`eve_ativo`),
  ...
  CONSTRAINT `fk_eventos_dia_semana` FOREIGN KEY (`eve_fkdia_codigo`) REFERENCES `dias_semana` (`dia_sem_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_eventos_evento_ativo` FOREIGN KEY (`eve_ativo`) REFERENCES `evento_ativo` (`eve_ati_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_eventos_evento_tipo_repeticao` FOREIGN KEY (`eve_tip_rep_id`) REFERENCES `evento_tipo_repeticao` (`eve_tip_rep_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_eventos_filtro_evento` FOREIGN KEY (`eve_fkfiltro_evento`) REFERENCES `filtro_evento` (`fil_eve_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_eventos_usuario` FOREIGN KEY (`eve_usu_id`) REFERENCES `usuario` (`usu_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `eventos` VALUES (1,'Teste','Teste','Anderson','(85) 98888-8888','a@gmail.com','2018-08-04 08:00:00','2018-08-04 12:00:00','2018-08-04 08:00:00','2018-08-04 12:00:00',1,6,2,3,4,'1',3153632204984,1,1);
/*!40000 ALTER TABLE `eventos` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `filtro_evento`
--

DROP TABLE IF EXISTS `filtro_evento`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `filtro_evento` (
  `fil_eve_id` int(11) NOT NULL AUTO_INCREMENT,
  `fil_eve_desc` varchar(45) NOT NULL,
  PRIMARY KEY (`fil_eve_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `filtro_evento`
--

LOCK TABLES `filtro_evento` WRITE;
/*!40000 ALTER TABLE `filtro_evento` DISABLE KEYS */;
INSERT INTO `filtro_evento` VALUES (1,'Evento Interno'),(2,'Evento Externo');
/*!40000 ALTER TABLE `filtro_evento` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `refeicoes_evento` VALUES (2,'Lanche','emerson.henrique@ifce.edu.br');
...
INSERT INTO `semestres` VALUES (1,'2018.1','2018-05-07 00:00:00','2019-10-05 00:00:00',1);
...
INSERT INTO `servicos_evento` VALUES (1,'Limpeza Total','imatheusmoreira@gmail.com'),(2,'Limpeza apenas','alveesbezerra13@gmail.com'),(4,'Cobertura','anderson.alvesprogrammer@gmail.com');
...
INSERT INTO `setor_evento` VALUES (1,'Administrativo',1),(2,'Blocos de Ensino',1),(3,'Esportivo',1),(4,'Teste',2),(5,'dffdfddf',2),(6,'Teste',2),(7,'TEsteeee',2);
...
INSERT INTO `tipo_usuario` VALUES (1,'Administrador'),(2,'Operador'),(3,'Usuario');
...
INSERT INTO `usuario` VALUES (1,'Anderson','anderson','21232f297a57a5a743894a0e4a801fc3','anderson.alvesprogrammer@gmail.com',1,1),(2,'Thiago','thivalente','21232f297a57a5a743894a0e4a801fc3','thivalente@gmail.com',2,1),(3,'Matheus ','imatheusmoreira','21232f297a57a5a743894a0e4a801fc3','imatheusmoreira@gmail.com',3,1),(4,'Emerson','emerson','21232f297a57a5a743894a0e4a801fc3','emerson.henrique@ifce.edu.br',1,1),(5,'David','david','21232f297a57a5a743894a0e4a801fc3','david@gmail.com',2,1),(6,'Victor Moraes','victor','7813d1590d28a7dd372ad54b5d29d033','victor.moraes@gmail.com',3,1),(7,'Operador','operador','06d4f07c943a4da1c8bfe591abbc3579','operador@gmail.com',2,1),(8,'Administrador','administrador','91f5167c34c400758115c2a6826ec2e3','administrador@gmail.com',1,1),(9,'UsuÃ¡rio comum','usuario','f8032d5cae3de20fcec887f395ec9a6a','usuario@gmail.com',3,1);
...
-- Dump completed on 2018-08-03 16:21:59
